...
def search(input: str, term: str) -> str:
    """Searches a multi-line string (separated by lb),
    and returns the line minus the search term"""
...
def quick_command(command: str, **kwargs):
    ...
    Add args to the command with the "args" kwarg.
    Use 'ret_type' kwarg to typecast the return value,
    and 'term' to return value after term string."""
